...
" Replace mode                                   " fg             & bg
let s:RE = [ '#ffffff' , '#ff005f' , 231 , 197 ] " white          & brightred

let g:airline#themes#xbsd#palette = {}

let g:airline#themes#xbsd#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

let g:airline#themes#xbsd#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#xbsd#palette.insert_replace = {
      \ 'airline_a': [ s:RE[0]   , s:I1[1]   , s:RE[1]   , s:I1[3]   , ''     ] }

let g:airline#themes#xbsd#palette.visual = {
      \ 'airline_a': [ s:V1[0]   , s:V1[1]   , s:V1[2]   , s:V1[3]   , ''     ] }

let g:airline#themes#xbsd#palette.replace = copy(airline#themes#xbsd#palette.normal)
let g:airline#themes#xbsd#palette.replace.airline_a = [ s:RE[0] , s:RE[1] , s:RE[2] , s:RE[3] , '' ]


let s:IA = [ s:N2[1] , s:N3[1] , s:N2[3] , s:N3[3] , '' ]
let g:airline#themes#xbsd#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
